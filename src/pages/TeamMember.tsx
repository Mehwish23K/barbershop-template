    ...
    if (!member) {
        return (
            <div className="min-h-screen bg-gray-900 flex items-center justify-center">
                <div className="animate-pulse text-blue-400 text-xl">Loading team member...</div>
            </div>
        )
    }
          ...
          <div className='relative h-[50vh] overflow-hidden'>
              ...
              >
                ...
                <p className="text-xl text-blue-400 max-w-2xl mx-auto">
                  {member.subheader} at Billy's Barber
                </p>
              </motion.div>
          </div>
            ...
            <div className="flex flex-col md:flex-row gap-12 items-start">
              ...
              >
                <div className="mb-8">
                  ...
                  <h2 className="text-3xl sm:text-4xl font-bold text-white font-serif mb-2">
                    {member.name}'s Story
                  </h2>
                  <p className="text-blue-400 italic">{member.subheader}</p>
                </div>
                ...
                <Link 
                  to="/team" 
                  className="mt-8 inline-flex items-center text-blue-400 hover:text-blue-300 transition-colors"
                >
              ...
              <motion.div 
                ...
                viewport={{ once: true }}
              >
                <div className="absolute -inset-4 bg-blue-600/20 rounded-xl blur-xl -z-10"></div>
                <img 
                  src={member.image} 
                  className="w-full h-auto rounded-xl shadow-2xl border-2 border-gray-700 hover:border-blue-500 transition-all duration-300"
                  alt={`Portrait of ${member.name}`}
                />
                <div className="mt-6 text-center">
                  <span className="inline-block px-4 py-2 bg-blue-600/20 text-blue-400 rounded-full text-sm font-medium">
                    {member.subheader}
                  </span>
                </div>
              </motion.div>
